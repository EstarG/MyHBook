 ...
 <body id="book">
    ...
    <div class="w">
        <div class="breadcrumb">
            ...
            <span> &nbsp;&gt;&nbsp;<font size="3"> 好评书籍 </font></span>
            <div id="hotkeywords"></div>
        </div>
    </div>
    <!--crumb end-->

<s:form action="highBooks_BookAction" method="post">
	<!-- 传递参数分页   -->
	    ...
	    <div id="select-attr" class="m" >
	        <div class="mt" style="margin-left: 180px; width: 80%">
	            ...
	            <s:hidden name="selectDetail" id = "selectDetail" value="%{ selectDetail }"></s:hidden>
	           	<strong> <span id="selID" style="color: red; margin-left: 20px">${ selectDetail }</span> 
	       		</strong>
	        </div>
	         <dl>
	             <dt>客户评分：</dt>
	    ...
	    <div class="m" id="plist"> 
			<s:iterator var="highBook" value="highBooks">
	        	<div class="item" sku="1055640717">
	                ...
	                <dt class="p-name">
	                <a target="_blank" href="clientQueryById_BookAction?book.id=${ highBook.id }" title="${ highBook.name }">
	                		${ highBook.name }
	                </a></dt>
	                ...
	                <dd class="p-price">
	                    ...
	                    <div class="dd"> <div class="dd">
	                    	<strong>￥<fmt:formatNumber type="number" value="${ highBook.hbPrice}" maxFractionDigits="1"/></strong><span class="discount">(${ highBook.discount }折)</span> 
	                    </div></span></div>
	                </dd>
	                <dd class="p-market">
	                    <div class="dt">定&#12288;&#12288;价：</div>
	                    <div class="dd"><del> ￥${ highBook.price }</del></div>
	                </dd>
	                <div class="clr"></div>
	            ...
	            <ul class="summary">            
	                <li class="summary-author">
	                    ...
	                    <div class="dd">
	           				<c:forEach var="author" items="${highBook.TAuthors}" varStatus="vs">  
	                ...
	                <li class="summary-press">
	                    <div class="dt">出 版 社：</div>
	                       <div class="dd">
	                         <a target="_blank" href="javascript:void(0)" >${ highBook.publisher }</a>
	                       </div>
	                </li>
	                <li class="summary-time">
	                    <div class="dt">出版时间：</div>
	                    <div class="dd">  <s:date name="#highBook.publishDate" format="yyyy-MM-dd" /></div>
	                </li>
	                <li class="summary-grade">
	                    <div class="dt">顾客评价：</div>
	                    <div class="dd"><span class="star"><span class="star-white"><span class="star-yellow h${highBook.grade} }">&nbsp;</span></span></span><a href="indexEvaluate_EvaluateAction?book.id=${ highBook.id }" target="_blank">(评价)</a></div>
	                </li>
	            ...
	            <div class="p-img">
	                <a target="_blank" href="clientQueryById_BookAction?book.id=${ highBook.id }" title="${ highBook.name }">                   
	                    <img data-img="1" src="${ highBook.picture }" width="160" height="160" alt="${ highBook.name }">                   
	                </a>
	            </div>
	
	            <div class="btns">
	                <a class="" target="_blank" href="addToCart_CartAction?bookid=${highBook.id}">
