    ...
    <div class="w">
        <div class="breadcrumb">
            <strong><a href="index_UIAction">图书</a></strong>
             <span> &nbsp;&gt;&nbsp;<font size="3"> 二手市场 </font></span>
            <div id="hotkeywords"></div>
        </div>
    </div>
    <!--crumb end-->

<s:form action="usedBooks_BookAction" method="post">
		<!-- 传递参数分页   -->
	    ...
	    <div class="m" id="plist"> 
			<s:iterator var="usedBook" value="usedBooks">
	        	<div class="item" sku="1055640717">
	                ...
	                <dt class="p-name">
	                <a target="_blank" href="clientQueryById_BookAction?book.id=${ usedBook.id }" title="${ usedBook.name }">
	                		${ usedBook.name }
	                </a></dt>
	
	                <dd class="p-price">
	                    <div class="dt">汇 书  价：</div>
	                    <div class="dd"><strong>￥<fmt:formatNumber type="number" value="${ usedBook.hbPrice }" maxFractionDigits="1"/></strong><span class="discount">(${ usedBook.discount }折)</span></div>
	                </dd>
	                <dd class="p-market">
	                    <div class="dt">定&#12288;&#12288;价：</div>
	                    <div class="dd"><del> ￥${ usedBook.price }</del></div>
	                </dd>
	                <div class="clr"></div>
	            ...
	            <ul class="summary">            
	                <li class="summary-author">
	                    ...
	                    <div class="dd">
	           				<c:forEach var="author" items="${usedBook.TAuthors}" varStatus="vs">  
	                ...
	                <li class="summary-press">
	                    <div class="dt">出 版 社：</div>
	                       <div class="dd">
	                         <a target="_blank" href="javascript:void(0)" >${ usedBook.publisher }</a>
	                       </div>
	                </li>
	                <li class="summary-time">
	                    <div class="dt">出版时间：</div>
	                    <div class="dd">  <s:date name="#usedBook.publishDate" format="yyyy-MM-dd" /></div>
	                </li>
	                <li class="summary-grade">
	                    <div class="dt">顾客评价：</div>
	                    <div class="dd"><span class="star"><span class="star-white"><span class="star-yellow h${ usedBook.grade }">&nbsp;</span></span></span><a href="indexEvaluate_EvaluateAction?book.id=${ usedBook.id }" target="_blank">(评价)</a></div>
	                </li>
	            ...
	            <div class="p-img">
	                <a target="_blank" href="clientQueryById_BookAction?book.id=${ usedBook.id }" title="${ usedBook.name }">                   
	                    <img data-img="1" src="${ usedBook.picture }" width="160" height="160" alt="${ usedBook.name }">                   
	                </a>
	            </div>
	
	            <div class="btns">
	                <a class="" target="_blank" href="addToCart_CartAction?bookid=${usedBook.id}">
