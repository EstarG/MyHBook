 ...
 <body id="book">
    ...
    <div class="w">
        <div class="breadcrumb">
            ...
            <span> &nbsp;&gt;&nbsp;<font size="3"> 热销供应 </font></span>
            <div id="hotkeywords"></div>
        </div>
    </div>
    <!--crumb end-->

<s:form action="hotBooks_BookAction" method="post">
<!-- 传递参数分页   -->
			...
			<s:iterator var="hotBook" value="hotBooks">
	        	<div class="item" sku="1055640717">
	                ...
	                <dd class="p-price">
	                    ...
	                    <div class="dd"> 
	                    	<strong>￥<fmt:formatNumber type="number" value="${ hotBook.hbPrice}" maxFractionDigits="1"/></strong><span class="discount">(${ hotBook.discount }折)</span> 
	                    </div>
	                </dd>
	                <dd class="p-market">
	                    <div class="dt">定&#12288;&#12288;价：</div>
	                    <div class="dd"><del> ￥${ hotBook.price }</del></div>
	                </dd>
	                <div class="clr"></div>
	            ...
	            <ul class="summary">            
	                <li class="summary-author">
	                    ...
	                    <div class="dd">
	           				<c:forEach var="author" items="${hotBook.TAuthors}" varStatus="vs">  
	                ...
	                <li class="summary-press">
	                    <div class="dt">出 版 社：</div>
	                       <div class="dd">
	                         <a target="_blank" href="javascript:void(0)" >${ hotBook.publisher }</a>
	                       </div>
	                </li>
	                <li class="summary-time">
	                    <div class="dt">出版时间：</div>
	                    <div class="dd">  <s:date name="#hotBook.publishDate" format="yyyy-MM-dd" /></div>
	                </li>
	                <li class="summary-grade">
	                    <div class="dt">顾客评价：</div>
	                    <div class="dd"><span class="star"><span class="star-white"><span class="star-yellow h${ hotBook.grade }">&nbsp;</span></span></span><a href="indexEvaluate_EvaluateAction?book.id=${ hotBook.id }" target="_blank">(评价)</a></div>
	                </li>
	            ...
	            <div class="p-img">
	                <a target="_blank" href="clientQueryById_BookAction?book.id=${ hotBook.id }" title="${ hotBook.name }">                   
	                    <img data-img="1" src="${ hotBook.picture }" width="160" height="160" alt="${ hotBook.name }">                   
	                </a>
	            </div>
	
	            <div class="btns">
	                <a class="" target="_blank" href="addToCart_CartAction?bookid=${hotBook.id}">
